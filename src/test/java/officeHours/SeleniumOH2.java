...
public class SeleniumOH2 {
    public static void main(String[] args) {
        ...
        //Before we automates anything we need tto Manually check or test it first.
        // We also have to know what we are searching for : example either by name, by id, etc....
        //Note that .getText() doesnt take any element but return a String (text) from the element
