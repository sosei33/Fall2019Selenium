package com.atomation.test.day10_vytrackCon;
...
public class CalendarEventsPageTest {
    ...
    private By createCalendarEventBtnBy = By.cssSelector("Create Calendar event");
    @BeforeMethod
    public void setup() {
        driver = DriverFactory.createDriver("chrome");
        driver.get("https://qa2.vytrack.com/user/login");
    ...
    public void verifyCreateButton(){
            ...
            WebElement crateCalendarEventBtn = driver.findElement(createCalendarEventBtnBy);
            Assert.assertTrue(crateCalendarEventBtn.isDisplayed());
            BrowserUtils.wait(5);
