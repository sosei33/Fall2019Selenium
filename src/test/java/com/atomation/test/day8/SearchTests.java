...
public class SearchTests {
    ...
    public void googleSearchTest(){
        ...
        BrowserUtils.wait(2);
        //since every search item has a tag nwme <h3>
        ...
        for(WebElement searchItem : searchItems){
            ...
            if(!var.isEmpty()){
                ...
                //Insted of printing we can use assertion
                //This verify that every search result contains java
 ...
 */
    ...
    /*
    //SECOND HALF BEGINS FROM AMAZON TEST
